...
function Home() {
    ...
    return (
        <>
            ...
            {popUp}
            <section class="col-span-full text-center py-10 px-32 bg-main">
    <h2 class="mb-20 text-3xl font-bold text-white">Why is it so great?</h2>

    <div class="grid lg:grid-cols-3 lg:gap-x-20">
      <div class="mb-12 lg:mb-0">
        <div
          class="block h-full rounded-lg bg-third shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] text-white">
          <div class="flex justify-center">
            <div class="-mt-8 inline-block rounded-full bg-second p-4 text-primary shadow-md">

        ...
        <nav className={navClass}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">LeetCoach</span>
                </Link>
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:border-0">
                        <li>
                        <Link to='/decks' activeClassName='' className="block py-2 pl-3 pr-4 md:bg-transparent md:p-0 md:hover:text-gray-300 text-white" aria-current="page">Decks</Link>
                        </li>
                        <li>
